...
public class WebScenarioTests : SmokeTests
{
    ...
    private static IEnumerable<TestScenario> GetScenarios()
    {
        ...
        if (!Config.ExcludeOnlineTests)
        {
            ...
            yield return new(nameof(WebScenarioTests), DotNetLanguage.FSharp, DotNetTemplate.Mvc, DotNetActions.Build | DotNetActions.Run | DotNetActions.Publish) { NoHttps = true };
