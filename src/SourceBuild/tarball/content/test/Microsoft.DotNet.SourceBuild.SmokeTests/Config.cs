...
internal static class Config
{
    ...
    public const string PreviouslySourceBuiltPackagesPathEnv = "SMOKE_TESTS_PREVIOUSLY_SOURCE_BUILT_PATH";
    ...
    public static string? PreviouslySourceBuiltPackagesPath { get; } = Environment.GetEnvironmentVariable(PreviouslySourceBuiltPackagesPathEnv);
