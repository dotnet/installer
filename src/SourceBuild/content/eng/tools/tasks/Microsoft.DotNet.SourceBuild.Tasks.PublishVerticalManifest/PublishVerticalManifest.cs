    ...
    public class PublishVerticalManifest : Task
    {
        ...
        public override bool Execute()
        {
            var assetManifestXmls = Directory.GetFiles(AssetManifestsLocalStorageDir, "*.xml", SearchOption.AllDirectories)
                .Select(xmlPath => XDocument.Load(xmlPath));
            ...
            packageElements.OrderBy(packageElement => packageElement.Attribute("Id").Value);
            blobElements.OrderBy(blobElement => blobElement.Attribute("Id").Value);
