...
public class WebScenarioTests : SmokeTests
{
    ...
    private static IEnumerable<TestScenario> GetScenarios()
    {
        ...
        {
            yield return new(nameof(WebScenarioTests), language, DotNetTemplate.Web,    DotNetActions.Build | DotNetActions.Run | (string.Equals(Config.TargetArchitecture,"ppc64le") || string.Equals(Config.TargetArchitecture,"s390x") ? DotNetActions.None : DotNetActions.PublishComplex));
